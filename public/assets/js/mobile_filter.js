function filterList() {
  ...
  arrList[arrList.length] = "청산가리";
  arrList[arrList.length] = "청산가루";
  arrList[arrList.length] = "(ㄱ+한자+3페이지 4번)";
  arrList[arrList.length] = "　";
  arrList[arrList.length] = "⠀";
  arrList[arrList.length] = "ㅤ";
  arrList[arrList.length] = "---";
  arrList[arrList.length] = "▪️";
  arrList[arrList.length] = "▪";
  arrList[arrList.length] = "◾";
  arrList[arrList.length] = "·";
  arrList[arrList.length] = "――";
  arrList[arrList.length] = "- -";
  arrList[arrList.length] = "― ―";
  arrList[arrList.length] = "^^ 7";
  arrList[arrList.length] = "^ ^ 7";
  arrList[arrList.length] = "^^7";
  arrList[arrList.length] = "^7";
  arrList[arrList.length] = ";;";
  arrList[arrList.length] = "^노^";
  arrList[arrList.length] = "￣";
  arrList[arrList.length] = "⊥";
  arrList[arrList.length] = "─ ─";
  arrList[arrList.length] = "━ ━";
  ...
  arrList[arrList.length] = "━━";
  arrList[arrList.length] = "┴";
  arrList[arrList.length] = "้";
  arrList[arrList.length] = "̆̈";
  arrList[arrList.length] = "1빠";
  arrList[arrList.length] = "==";
  arrList[arrList.length] = "2빠";
  arrList[arrList.length] = "910이";
  arrList[arrList.length] = "910일";
  arrList[arrList.length] = "910임";
  arrList[arrList.length] = "D쥐고";
  arrList[arrList.length] = "D지고";
  arrList[arrList.length] = "JMT";
  arrList[arrList.length] = "jonna";
  arrList[arrList.length] = "jot같";
  arrList[arrList.length] = "mi쳤";
  arrList[arrList.length] = "ssㅑ";
  arrList[arrList.length] = "tlqkf";
  arrList[arrList.length] = "wlfkf";
  arrList[arrList.length] = "🍆";
  arrList[arrList.length] = "ㄱㄷ";
  arrList[arrList.length] = "ㄱㅇㄷ";
  arrList[arrList.length] = "가지가지";
  arrList[arrList.length] = "같은 새끼";
  arrList[arrList.length] = "같은새끼";
  arrList[arrList.length] = "개 새끼";
  arrList[arrList.length] = "개같";
  arrList[arrList.length] = "개나 소나";
  arrList[arrList.length] = "개나대";
  arrList[arrList.length] = "개나소나";
  arrList[arrList.length] = "개넷";
  arrList[arrList.length] = "개년";
  arrList[arrList.length] = "개념빠가";
  arrList[arrList.length] = "개독";
  arrList[arrList.length] = "개돼지";
  arrList[arrList.length] = "개련";
  arrList[arrList.length] = "개련";
  arrList[arrList.length] = "개마이";
  arrList[arrList.length] = "개부랄";
  arrList[arrList.length] = "개삼성";
  arrList[arrList.length] = "개새기";
  arrList[arrList.length] = "개새끼";
  arrList[arrList.length] = "개섹";
  arrList[arrList.length] = "개셈";
  arrList[arrList.length] = "개소리";
  arrList[arrList.length] = "개쓰래기";
  arrList[arrList.length] = "개저씨";
  arrList[arrList.length] = "거른다";
  arrList[arrList.length] = "거지같은";
  arrList[arrList.length] = "계새끼";
  arrList[arrList.length] = "골 빈";
  arrList[arrList.length] = "골1빈";
  arrList[arrList.length] = "골빈";
  arrList[arrList.length] = "공개 처형";
  arrList[arrList.length] = "공개처형";
  arrList[arrList.length] = "관.종";
  arrList[arrList.length] = "관1종";
  arrList[arrList.length] = "관종";
  arrList[arrList.length] = "괘새끼";
  arrList[arrList.length] = "구1씹";
  arrList[arrList.length] = "구씹";
  arrList[arrList.length] = "그 나물에";
  arrList[arrList.length] = "그1켬";
  arrList[arrList.length] = "그나물에";
  arrList[arrList.length] = "그따구";
  arrList[arrList.length] = "그따위";
  arrList[arrList.length] = "그지 같";
  arrList[arrList.length] = "그지같";
  arrList[arrList.length] = "그켬";
  arrList[arrList.length] = "극1혐";
  arrList[arrList.length] = "극혐";
  arrList[arrList.length] = "글러 먹";
  arrList[arrList.length] = "글러먹";
  arrList[arrList.length] = "기레기";
  arrList[arrList.length] = "기자레기";
  arrList[arrList.length] = "김치녀";
  arrList[arrList.length] = "까내리";
  arrList[arrList.length] = "껒여";
  arrList[arrList.length] = "꼬라지";
  arrList[arrList.length] = "꼬라지";
  arrList[arrList.length] = "꼴갑";
  arrList[arrList.length] = "꼴값";
  arrList[arrList.length] = "꼴깝";
  arrList[arrList.length] = "꼴데";
  arrList[arrList.length] = "꼴랑";
  arrList[arrList.length] = "꼴보기";
  arrList[arrList.length] = "꼴뵈기";
  arrList[arrList.length] = "나빼썅";
  arrList[arrList.length] = "나쁜 새끼";
  arrList[arrList.length] = "넌씨눈";
  arrList[arrList.length] = "년놈";
  arrList[arrList.length] = "노무노무";
  arrList[arrList.length] = "노알라";
  arrList[arrList.length] = "노인네";
  arrList[arrList.length] = "노친네";
  arrList[arrList.length] = "뇌 텅";
  arrList[arrList.length] = "뇌1텅";
  arrList[arrList.length] = "뇌에";
  arrList[arrList.length] = "뇌텅";
  arrList[arrList.length] = "뇌피셜";
  arrList[arrList.length] = "눈깔 파";
  arrList[arrList.length] = "눈깔파";
  arrList[arrList.length] = "눈새";
  arrList[arrList.length] = "늬믜";
  arrList[arrList.length] = "늬미";
  arrList[arrList.length] = "니년";
  arrList[arrList.length] = "니믜";
  arrList[arrList.length] = "니미럴";
  arrList[arrList.length] = "닝기리";
  arrList[arrList.length] = "ㄷㅇㅂ";
  arrList[arrList.length] = "다꺼져";
  arrList[arrList.length] = "닥1";
  arrList[arrList.length] = "닥2";
  arrList[arrList.length] = "닥전";
  arrList[arrList.length] = "닥쳐라";
  arrList[arrList.length] = "닥치세";
  arrList[arrList.length] = "닥후";
  arrList[arrList.length] = "대가리";
  arrList[arrList.length] = "대갈";
  arrList[arrList.length] = "더럽네";
  arrList[arrList.length] = "덜떨어";
  arrList[arrList.length] = "덬";
  arrList[arrList.length] = "도라이";
  arrList[arrList.length] = "도랏";
  arrList[arrList.length] = "도랐";
  arrList[arrList.length] = "도른";
  arrList[arrList.length] = "돌앗구만";
  arrList[arrList.length] = "돌앗나";
  arrList[arrList.length] = "돌앗네";
  arrList[arrList.length] = "돌았구만";
  arrList[arrList.length] = "돌았나";
  arrList[arrList.length] = "돌았네";
  arrList[arrList.length] = "둄마";
  arrList[arrList.length] = "뒈져";
  arrList[arrList.length] = "뒤져라";
  arrList[arrList.length] = "뒤져버";
  arrList[arrList.length] = "뒤져야";
  arrList[arrList.length] = "뒤져야지";
  arrList[arrList.length] = "뒤져요";
  arrList[arrList.length] = "뒤졌";
  arrList[arrList.length] = "뒤지겠";
  arrList[arrList.length] = "뒤지고싶";
  arrList[arrList.length] = "뒤지길";
  arrList[arrList.length] = "뒤진다";
  arrList[arrList.length] = "뒤질";
  arrList[arrList.length] = "듣보";
  arrList[arrList.length] = "디져라";
  arrList[arrList.length] = "디졌";
  arrList[arrList.length] = "디지고";
  arrList[arrList.length] = "디질";
  arrList[arrList.length] = "딴년";
  arrList[arrList.length] = "또라이";
  arrList[arrList.length] = "또라인";
  arrList[arrList.length] = "똘아이";
  arrList[arrList.length] = "뚝배기";
  arrList[arrList.length] = "뚫린 입";
  arrList[arrList.length] = "뚫린입";
  arrList[arrList.length] = "라면갤";
  arrList[arrList.length] = "런년";
  arrList[arrList.length] = "럼들";
  arrList[arrList.length] = "레1친";
  arrList[arrList.length] = "레기같";
  arrList[arrList.length] = "레기네";
  arrList[arrList.length] = "레기다";
  arrList[arrList.length] = "레친";
  arrList[arrList.length] = "롬들";
  arrList[arrList.length] = "ㅁ.ㄱ";
  arrList[arrList.length] = "ㅁㅊ";
  arrList[arrList.length] = "ㅁ친";
  arrList[arrList.length] = "막 내뱉";
  arrList[arrList.length] = "막내뱉";
  arrList[arrList.length] = "맘충";
  arrList[arrList.length] = "망돌";
  arrList[arrList.length] = "망해라";
  arrList[arrList.length] = "머갈";
  arrList[arrList.length] = "머리 텅";
  arrList[arrList.length] = "머리텅";
  arrList[arrList.length] = "먹.금";
  arrList[arrList.length] = "먹.끔";
  arrList[arrList.length] = "먹1금";
  arrList[arrList.length] = "먹금";
  arrList[arrList.length] = "먹끔";
  arrList[arrList.length] = "명존";
  arrList[arrList.length] = "무개념";
  arrList[arrList.length] = "뭐래는";
  arrList[arrList.length] = "뭐임";
  arrList[arrList.length] = "뭐저래";
  arrList[arrList.length] = "뭔솔";
  arrList[arrList.length] = "믜칀";
  arrList[arrList.length] = "믜친";
  arrList[arrList.length] = "미: 놈";
  arrList[arrList.length] = "미:놈";
  arrList[arrList.length] = "미1친";
  arrList[arrList.length] = "미놈";
  arrList[arrList.length] = "미시친발";
  arrList[arrList.length] = "미쳣네";
  arrList[arrList.length] = "미쳤나";
  arrList[arrList.length] = "미쳤니";
  arrList[arrList.length] = "미췬";
  arrList[arrList.length] = "미칀";
  arrList[arrList.length] = "미친 새";
  arrList[arrList.length] = "미친~";
  arrList[arrList.length] = "미친개";
  arrList[arrList.length] = "미친새";
  arrList[arrList.length] = "미친색";
  arrList[arrList.length] = "미친ㅋ";
  arrList[arrList.length] = "미틴";
  arrList[arrList.length] = "및힌";
  arrList[arrList.length] = "ㅂㄹ";
  arrList[arrList.length] = "ㅂㅁㄱ";
  arrList[arrList.length] = "ㅂㅊ";
  arrList[arrList.length] = "ㅂ크";
  arrList[arrList.length] = "발놈";
  arrList[arrList.length] = "별창";
  arrList[arrList.length] = "병1신";
  arrList[arrList.length] = "병1크";
  arrList[arrList.length] = "병맛";
  arrList[arrList.length] = "병신";
  arrList[arrList.length] = "병크";
  arrList[arrList.length] = "봊";
  arrList[arrList.length] = "븅신";
  arrList[arrList.length] = "빠큐";
  arrList[arrList.length] = "빡새끼";
  arrList[arrList.length] = "빻았";
  arrList[arrList.length] = "빻은";
  arrList[arrList.length] = "뻐규";
  arrList[arrList.length] = "뻐큐";
  arrList[arrList.length] = "뻑유";
  arrList[arrList.length] = "뻑큐";
  arrList[arrList.length] = "뻨큐";
  arrList[arrList.length] = "뼈큐";
  arrList[arrList.length] = "뽄새";
  arrList[arrList.length] = "뽄세";
  arrList[arrList.length] = "삐걱";
  arrList[arrList.length] = "ㅄ";
  arrList[arrList.length] = "ㅅ";
  arrList[arrList.length] = "ㅂ";
  arrList[arrList.length] = "ㅅ.ㅂ";
  arrList[arrList.length] = "ㅅ1ㅂ";
  arrList[arrList.length] = "ㅅ1발";
  arrList[arrList.length] = "ㅅㄲ네";
  arrList[arrList.length] = "ㅅㄲ들";
  arrList[arrList.length] = "ㅅ루";
  arrList[arrList.length] = "ㅅㅋ";
  arrList[arrList.length] = "ㅅㅌㅊ";
  arrList[arrList.length] = "ㅅㅡ루";
  arrList[arrList.length] = "사새끼";
  arrList[arrList.length] = "새.끼";
  arrList[arrList.length] = "새1끼";
  arrList[arrList.length] = "새1키";
  arrList[arrList.length] = "새77ㅣ";
  arrList[arrList.length] = "새끼라";
  arrList[arrList.length] = "새끼야";
  arrList[arrList.length] = "새퀴";
  arrList[arrList.length] = "새킈";
  arrList[arrList.length] = "새키";
  arrList[arrList.length] = "색희";
  arrList[arrList.length] = "색히";
  arrList[arrList.length] = "샊기";
  arrList[arrList.length] = "샊히";
  arrList[arrList.length] = "샹년";
  arrList[arrList.length] = "섀키";
  arrList[arrList.length] = "서치해";
  arrList[arrList.length] = "섬숭이";
  arrList[arrList.length] = "성괴";
  arrList[arrList.length] = "솔1친";
  arrList[arrList.length] = "솔친";
  arrList[arrList.length] = "수준하고는";
  arrList[arrList.length] = "쉬발";
  arrList[arrList.length] = "쉬버";
  arrList[arrList.length] = "쉬이바";
  arrList[arrList.length] = "쉬이이";
  arrList[arrList.length] = "쉬이이이";
  arrList[arrList.length] = "쉬펄";
  arrList[arrList.length] = "슈1발";
  arrList[arrList.length] = "슈레기";
  arrList[arrList.length] = "슈발";
  arrList[arrList.length] = "슈벌";
  arrList[arrList.length] = "슈우벌";
  arrList[arrList.length] = "슈ㅣ발";
  arrList[arrList.length] = "스.루";
  arrList[arrList.length] = "스ㄹㅜ";
  arrList[arrList.length] = "스벌";
  arrList[arrList.length] = "스죄";
  arrList[arrList.length] = "스타죄국";
  arrList[arrList.length] = "슨상님";
  arrList[arrList.length] = "싑창";
  arrList[arrList.length] = "시1발";
  arrList[arrList.length] = "시미발친";
  arrList[arrList.length] = "시미친발";
  arrList[arrList.length] = "시바 ";
  arrList[arrList.length] = "시바라지";
  arrList[arrList.length] = "시바류";
  arrList[arrList.length] = "시바시바";
  arrList[arrList.length] = "시바알";
  arrList[arrList.length] = "시바앙";
  arrList[arrList.length] = "시발";
  arrList[arrList.length] = "시방새";
  arrList[arrList.length] = "시벌탱";
  arrList[arrList.length] = "시볼탱";
  arrList[arrList.length] = "시부럴";
  arrList[arrList.length] = "시부렬";
  arrList[arrList.length] = "시부울";
  arrList[arrList.length] = "시뷰럴";
  arrList[arrList.length] = "시뷰렬";
  arrList[arrList.length] = "시빨";
  arrList[arrList.length] = "시새발끼";
  arrList[arrList.length] = "시이발";
  arrList[arrList.length] = "시친발미";
  arrList[arrList.length] = "시키가";
  arrList[arrList.length] = "시팔";
  arrList[arrList.length] = "시펄";
  arrList[arrList.length] = "십창";
  arrList[arrList.length] = "십팔";
  arrList[arrList.length] = "ㅆ1ㄺ";
  arrList[arrList.length] = "ㅆ1ㅂ";
  arrList[arrList.length] = "ㅆㄹㄱ";
  arrList[arrList.length] = "ㅆㄺ";
  arrList[arrList.length] = "ㅆㅂ";
  arrList[arrList.length] = "싸가지 없";
  arrList[arrList.length] = "싸가지없";
  arrList[arrList.length] = "싸물어";
  arrList[arrList.length] = "쌉";
  arrList[arrList.length] = "쌍년";
  arrList[arrList.length] = "쌍놈";
  arrList[arrList.length] = "쌔끼";
  arrList[arrList.length] = "썅";
  arrList[arrList.length] = "썌끼";
  arrList[arrList.length] = "쒸펄";
  arrList[arrList.length] = "쓰1레기";
  arrList[arrList.length] = "쓰래기같";
  arrList[arrList.length] = "쓰레기 새";
  arrList[arrList.length] = "쓰레기새";
  arrList[arrList.length] = "쓰렉";
  arrList[arrList.length] = "씝창";
  arrList[arrList.length] = "씨1발";
  arrList[arrList.length] = "씨바라";
  arrList[arrList.length] = "씨바알";
  arrList[arrList.length] = "씨발";
  arrList[arrList.length] = "씨방새";
  arrList[arrList.length] = "씨버럼";
  arrList[arrList.length] = "씨벌";
  arrList[arrList.length] = "씨벌탱";
  arrList[arrList.length] = "씨볼탱";
  arrList[arrList.length] = "씨부럴";
  arrList[arrList.length] = "씨부렬";
  arrList[arrList.length] = "씨뷰럴";
  arrList[arrList.length] = "씨뷰렬";
  arrList[arrList.length] = "씨빠빠";
  arrList[arrList.length] = "씨빨";
  arrList[arrList.length] = "씨뻘";
  arrList[arrList.length] = "씨새발끼";
  arrList[arrList.length] = "씨이발";
  arrList[arrList.length] = "씨팔";
  arrList[arrList.length] = "씹귀";
  arrList[arrList.length] = "씹덕";
  arrList[arrList.length] = "씹못";
  arrList[arrList.length] = "씹뻐럴";
  arrList[arrList.length] = "씹새끼";
  arrList[arrList.length] = "씹쌔";
  arrList[arrList.length] = "씹창";
  arrList[arrList.length] = "씹치";
  arrList[arrList.length] = "씹팔";
  arrList[arrList.length] = "씹할";
  arrList[arrList.length] = "ㅇㅍㅊㅌ";
  arrList[arrList.length] = "ㅇㅒ쁜";
  arrList[arrList.length] = "아가리";
  arrList[arrList.length] = "아닥";
  arrList[arrList.length] = "아오 ㅅㅂ";
  arrList[arrList.length] = "아오 시바";
  arrList[arrList.length] = "아오ㅅㅂ";
  arrList[arrList.length] = "아오시바";
  arrList[arrList.length] = "안물안궁";
  arrList[arrList.length] = "애미";
  arrList[arrList.length] = "앰";
  arrList[arrList.length] = "앰창";
  arrList[arrList.length] = "얘쁘";
  arrList[arrList.length] = "얘쁜";
  arrList[arrList.length] = "얪";
  arrList[arrList.length] = "에라이 퉤";
  arrList[arrList.length] = "에라이 퉷";
  arrList[arrList.length] = "에라이퉤";
  arrList[arrList.length] = "에라이퉷";
  arrList[arrList.length] = "엠뷩신";
  arrList[arrList.length] = "엠븽신";
  arrList[arrList.length] = "엠빙신";
  arrList[arrList.length] = "엠생";
  arrList[arrList.length] = "엠창";
  arrList[arrList.length] = "엿같";
  arrList[arrList.length] = "엿이나";
  arrList[arrList.length] = "예.질";
  arrList[arrList.length] = "예1질";
  arrList[arrList.length] = "예질";
  arrList[arrList.length] = "옘병";
  arrList[arrList.length] = "염병";
  arrList[arrList.length] = "오크";
  arrList[arrList.length] = "와꾸";
  arrList[arrList.length] = "왜저럼";
  arrList[arrList.length] = "외1퀴";
  arrList[arrList.length] = "외퀴";
  arrList[arrList.length] = "웅앵웅";
  arrList[arrList.length] = "웅엥웅";
  arrList[arrList.length] = "은년";
  arrList[arrList.length] = "은새끼";
  arrList[arrList.length] = "이 새끼";
  arrList[arrList.length] = "이따위";
  arrList[arrList.length] = "이새끼";
  arrList[arrList.length] = "인간말종";
  arrList[arrList.length] = "一 一";
  arrList[arrList.length] = "一 ㅡ";
  arrList[arrList.length] = "一一";
  arrList[arrList.length] = "一ㅡ";
  arrList[arrList.length] = "입 털";
  arrList[arrList.length] = "입털";
  arrList[arrList.length] = "ㅈ.ㄴ";
  arrList[arrList.length] = "ㅈㄴ";
  arrList[arrList.length] = "ㅈㄹ";
  arrList[arrList.length] = "자업자득";
  arrList[arrList.length] = "작작";
  arrList[arrList.length] = "잘또";
  arrList[arrList.length] = "저따위";
  arrList[arrList.length] = "지잡";
  arrList[arrList.length] = "검머외";
  arrList[arrList.length] = "절라";
  arrList[arrList.length] = "정떨";
  arrList[arrList.length] = "정병";
  arrList[arrList.length] = "정신나갓";
  arrList[arrList.length] = "정신나갔";
  arrList[arrList.length] = "젖 같";
  arrList[arrList.length] = "젗같";
  arrList[arrList.length] = "젼나";
  arrList[arrList.length] = "젼낰";
  arrList[arrList.length] = "졀라";
  arrList[arrList.length] = "졀리";
  arrList[arrList.length] = "졌같은";
  arrList[arrList.length] = "졏 같";
  arrList[arrList.length] = "조낸";
  arrList[arrList.length] = "조녜";
  arrList[arrList.length] = "조온나";
  arrList[arrList.length] = "족까";
  arrList[arrList.length] = "존 나";
  arrList[arrList.length] = "존 나";
  arrList[arrList.length] = "존.나";
  arrList[arrList.length] = "존1";
  arrList[arrList.length] = "존1나";
  arrList[arrList.length] = "존귀";
  arrList[arrList.length] = "존귘";
  arrList[arrList.length] = "존ㄴ나";
  arrList[arrList.length] = "존나";
  arrList[arrList.length] = "존낙";
  arrList[arrList.length] = "존내";
  arrList[arrList.length] = "존똑";
  arrList[arrList.length] = "존맛";
  arrList[arrList.length] = "존멋";
  arrList[arrList.length] = "존버";
  arrList[arrList.length] = "존싫";
  arrList[arrList.length] = "존쎄";
  arrList[arrList.length] = "존쎼";
  arrList[arrList.length] = "존예";
  arrList[arrList.length] = "존웃";
  arrList[arrList.length] = "존잘";
  arrList[arrList.length] = "존잼";
  arrList[arrList.length] = "존좋";
  arrList[arrList.length] = "존트";
  arrList[arrList.length] = "졸귀";
  arrList[arrList.length] = "졸귘";
  arrList[arrList.length] = "졸라 ";
  arrList[arrList.length] = "졸맛";
  arrList[arrList.length] = "졸멋";
  arrList[arrList.length] = "졸싫";
  arrList[arrList.length] = "졸예";
  arrList[arrList.length] = "졸웃";
  arrList[arrList.length] = "졸잼";
  arrList[arrList.length] = "졸좋";
  arrList[arrList.length] = "좁밥";
  arrList[arrList.length] = "좃";
  arrList[arrList.length] = "종나";
  arrList[arrList.length] = "좆";
  arrList[arrList.length] = "좆까";
  arrList[arrList.length] = "좇같";
  arrList[arrList.length] = "죠낸";
  arrList[arrList.length] = "죠온나";
  arrList[arrList.length] = "죤나";
  arrList[arrList.length] = "죤내";
  arrList[arrList.length] = "죵나";
  arrList[arrList.length] = "죶";
  arrList[arrList.length] = "죽어버려";
  arrList[arrList.length] = "죽여 버리고";
  arrList[arrList.length] = "죽여버리고";
  arrList[arrList.length] = "죽여불고";
  arrList[arrList.length] = "죽여뿌고";
  arrList[arrList.length] = "중립충";
  arrList[arrList.length] = "줬같은";
  arrList[arrList.length] = "쥐랄";
  arrList[arrList.length] = "쥰나";
  arrList[arrList.length] = "쥰내";
  arrList[arrList.length] = "쥰니";
  arrList[arrList.length] = "쥰트";
  arrList[arrList.length] = "즤랄";
  arrList[arrList.length] = "지 랄";
  arrList[arrList.length] = "지1랄";
  arrList[arrList.length] = "지1뢰";
  arrList[arrList.length] = "지껄이";
  arrList[arrList.length] = "지들이";
  arrList[arrList.length] = "지랄";
  arrList[arrList.length] = "지롤";
  arrList[arrList.length] = "지뢰";
  arrList[arrList.length] = "지인지조";
  arrList[arrList.length] = "ㅉ";
  arrList[arrList.length] = "ㅉ질한";
  arrList[arrList.length] = "짱깨";
  arrList[arrList.length] = "짱께";
  arrList[arrList.length] = "쪼녜";
  arrList[arrList.length] = "쪼다";
  arrList[arrList.length] = "착짱죽짱";
  arrList[arrList.length] = "섬숭이";
  arrList[arrList.length] = "쪽본";
  arrList[arrList.length] = "쪽1바리";
  arrList[arrList.length] = "쪽바리";
  arrList[arrList.length] = "쪽발";
  arrList[arrList.length] = "쫀 맛";
  arrList[arrList.length] = "쫀1";
  arrList[arrList.length] = "쫀귀";
  arrList[arrList.length] = "쫀맛";
  arrList[arrList.length] = "쫂";
  arrList[arrList.length] = "쫓같";
  arrList[arrList.length] = "쬰잘";
  arrList[arrList.length] = "쬲";
  arrList[arrList.length] = "쯰질";
  arrList[arrList.length] = "찌1질";
  arrList[arrList.length] = "찌질한";
  arrList[arrList.length] = "찍찍이";
  arrList[arrList.length] = "찎찎이";
  arrList[arrList.length] = "찝째끼";
  arrList[arrList.length] = "창년";
  arrList[arrList.length] = "창녀";
  arrList[arrList.length] = "창놈";
  arrList[arrList.length] = "창넘";
  arrList[arrList.length] = "처먹";
  arrList[arrList.length] = "凸";
  arrList[arrList.length] = "첫빠";
  arrList[arrList.length] = "쳐마";
  arrList[arrList.length] = "쳐먹";
  arrList[arrList.length] = "쳐받는";
  arrList[arrList.length] = "쳐발라";
  arrList[arrList.length] = "취ㅈ";
  arrList[arrList.length] = "취좃";
  arrList[arrList.length] = "친 년";
  arrList[arrList.length] = "친 놈";
  arrList[arrList.length] = "친구년";
  arrList[arrList.length] = "친년";
  arrList[arrList.length] = "친노마";
  arrList[arrList.length] = "친놈";
  arrList[arrList.length] = "텐귀";
  arrList[arrList.length] = "텐덕";
  arrList[arrList.length] = "톡디";
  arrList[arrList.length] = "ㅍㅌㅊ";
  arrList[arrList.length] = "파1친";
  arrList[arrList.length] = "파친";
  arrList[arrList.length] = "피코";
  arrList[arrList.length] = "피해자 코스프레";
  arrList[arrList.length] = "피해자코스프레";
  arrList[arrList.length] = "핑1프";
  arrList[arrList.length] = "핑거프린세스";
  arrList[arrList.length] = "핑끄";
  arrList[arrList.length] = "핑프";
  arrList[arrList.length] = "ㅎㅃ";
  arrList[arrList.length] = "ㅎㅌㅊ";
  arrList[arrList.length] = "할많하않";
  arrList[arrList.length] = "할말하않";
  arrList[arrList.length] = "헛소리";
  arrList[arrList.length] = "혐석";
  arrList[arrList.length] = "호로새끼";
  arrList[arrList.length] = "호로잡";
  arrList[arrList.length] = "화낭년";
  arrList[arrList.length] = "화냥년";
  arrList[arrList.length] = "후.려";
  arrList[arrList.length] = "후1려";
  arrList[arrList.length] = "후1빨";
  arrList[arrList.length] = "후려";
  arrList[arrList.length] = "후빨";
  arrList[arrList.length] = "ㅗ";
  arrList[arrList.length] = "ㅡ 一";
  arrList[arrList.length] = "ㅡ ㅡ";
  arrList[arrList.length] = "ㅡ一";
  arrList[arrList.length] = "————";
  arrList[arrList.length] = "ㅡㅡ";
  arrList[arrList.length] = "ㅡㅡ";
  arrList[arrList.length] = "ㅡㅡ";
  arrList[arrList.length] = "ส";
  arrList[arrList.length] = "ค็";
  arrList[arrList.length] = "้";
  arrList[arrList.length] = "็";
  arrList[arrList.length] = "zoomin.cur";
  arrList[arrList.length] = "eventHostId";
  arrList[arrList.length] = "m.instiz.net";
  arrList[arrList.length] = "open.";
  arrList[arrList.length] = "onchat";
  arrList[arrList.length] = "ajax_comment";
  arrList[arrList.length] = "stub-extra";
  arrList[arrList.length] = "-stub";
  arrList[arrList.length] = "line.me";
  arrList[arrList.length] = "ask.fm";
  arrList[arrList.length] = "adinc.co.kr";
  arrList[arrList.length] = "vonvon";
  arrList[arrList.length] = "superfeed";
  arrList[arrList.length] = "lumieyes";
  arrList[arrList.length] = "www.inlive";
  arrList[arrList.length] = "apt_review";
  arrList[arrList.length] = "showcat";
  arrList[arrList.length] = "쇼캣";
  arrList[arrList.length] = ".pls";
  arrList[arrList.length] = "stype=3";
  arrList[arrList.length] = "$('";
  arrList[arrList.length] = "bitly";
  arrList[arrList.length] = "president.go.kr";
  arrList[arrList.length] = "comment_memo";
  arrList[arrList.length] = "onmouse";
  arrList[arrList.length] = "onkey";
  arrList[arrList.length] = "미-친";
  arrList[arrList.length] = "시-발";
  arrList[arrList.length] = "지-랄";
  arrList[arrList.length] = "개-새-끼";
  arrList[arrList.length] = "또-라-이";
  arrList[arrList.length] = "디-질";
  arrList[arrList.length] = "걸-레";
  arrList[arrList.length] = "닥-쳐";
  arrList[arrList.length] = "등-신";
  arrList[arrList.length] = "뇌-텅텅";
  arrList[arrList.length] = "대-가-리";
  arrList[arrList.length] = "병-신";
  arrList[arrList.length] = "엠-창";
  arrList[arrList.length] = "조-ㅈ";
  arrList[arrList.length] = "염-병";
  arrList[arrList.length] = "쌍-판";
  arrList[arrList.length] = "쳐-";
  arrList[arrList.length] = "씹-";

  return arrList;
}
function wordFilterCheck(msg) {
  for (i = 0; i < FliterArrayList.length; i++) {
    var badWord = FliterArrayList[i];

    while (true) {
      if (msg.indexOf(badWord) != -1) {
        msg = msg.replace(badWord, "[xxx]");
        console.log("filtered : " + badWord)
      }
      else {
        break;
      }
...
let FliterArrayList = filterList();