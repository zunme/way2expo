                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-10">
                        <ul class="nav nav-pills nav-pills-black p-0" id="tab-favorites" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link nav-product active" data-toggle="tab" href="#product" role="tablist"
                                   aria-expanded="true">
                                    전시상품
                                </a>
                            </li>
                        ...
                        <div class="tab-content tab-space pt-4">
                            <div class="tab-pane active" id="product" aria-expanded="true">
    ...
    <script>
        const myFavorites = (function ($$) {
            ...
            function drawPaneContainer(tabId) {
                ...
                let pagination = result.append('<div>');
                let pageContent = result.append('<div>');
