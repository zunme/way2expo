    ...
    <script>
        ...
        $(function () {
            dataTable = $('#dataTable').DataTable({
                ...
                "dom": "<'row justify-content-between align-items-center'<'col-4'i>>" +
                    "<'row'<'col-sm-12'tr>>" +
                    "<'row'<'col-sm-12 col-md-5'P><'col-sm-12 col-md-7'p>>",
                "language": {
                    "info": "총 _TOTAL_개의 화상회의 신청이 있습니다.",
                    "infoFiltered": "",
                    "infoEmpty": "",
                    "emptyTable": "정보가 없습니다.",
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            if (data == null || typeof data == 'undefined') return '-'
                            if (data === 'R') return '<span class="text-info">대기</span>'
