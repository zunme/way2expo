...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="/admin_assets/stisla/node_modules/bootstrap-social/bootstrap-social.css">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="/image/fav180.png" alt="logo" width="100" class="shadow-light rounded-circle" style="background-color: #ffffff;box-shadow: 0 5px 8px #c3d5e4;">
            </div>
            ...
            <div class="mt-5 text-muted text-center">
              {{ __("계정이 없으시나요?") }}? <a href="/register">{{ __('가입하기') }}</a>
            </div>
            <div class="simple-footer">
              Copyright &copy; Way2EXPO 2020
            </div>
          </div>
        </div>
      </div>
